    ...
    <section class="testimonials-container">
      <b-row>
        <b-col class="text-center">
          <p class="title-text pb-3" id="testimonials">Testimonials</p>
      ...
      <b-row class="justify-content-center">
        <b-col lg="6" md="8" sm="10" cols="12" class="text-center">
            ...
            <div v-for="skill in skills" :key="skill.title" class="m-auto">
              <b-link target="_blank" class="p-3" :href="skill.web">
                <b-img
                  height="100"
                  weight="100"
                  :src="`../assets/images/${skill.title}.jpg`"
                  :alt="skill.alt"
                  :title="skill.alt"
                />
              </b-link>
          ...
          <BaseScrollTo desc="Want to work with me?" variantColor="outline-dark" descendTo="contact" />
        </b-col>
      </b-row>
    </section>
  </template>
